...
@property (nonatomic, strong) BAKit_ActivityIndicatorView *loadingView3;
...
- (BAKit_ActivityIndicatorView *)loadingView3
{
    if (!_loadingView3)
    {
        _loadingView3 = [BAKit_ActivityIndicatorView new];
