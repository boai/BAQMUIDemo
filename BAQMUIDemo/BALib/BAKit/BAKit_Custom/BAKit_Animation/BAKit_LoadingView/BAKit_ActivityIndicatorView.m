...
#import "BAKit_ActivityIndicatorView.h"
...
@interface BAKit_ActivityIndicatorView ()<CAAnimationDelegate>
#else
@interface BAKit_ActivityIndicatorView ()
#endif

@end


@implementation BAKit_ActivityIndicatorView
{
    CALayer *_line1;
    CALayer *_line2;
    CALayer *_line3;
